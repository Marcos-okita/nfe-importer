...
public final class ManifestacaoEventoRequestBuilder {
    ...
    /**
     * Codigo do orgao "Ambiente Nacional" - usado no evento independente da UF da
     * NF-e/do autor.
     */
    private static final int C_ORGAO_AMBIENTE_NACIONAL = 91;
     ...
     * da Operacao".
     */
    public static String cienciaOperacao(int tpAmb, String chaveAcesso, String cnpjAutor, Instant dhEvento,
            int nSeqEvento) {
        ...
        String infEvento = "<infEvento Id=\"" + idEvento + "\">"
                + "<cOrgao>" + C_ORGAO_AMBIENTE_NACIONAL + "</cOrgao>"
                + "<tpAmb>" + tpAmb + "</tpAmb>"
                + "<CNPJ>" + cnpjAutor + "</CNPJ>"
     ...
     * &lt;/wsdl:message&gt;
     * </pre>
     * A part referencia um ELEMENTO global ({@code element=}, nao {@code type=}) - esse e
     * exatamente o padrao "document/literal bare" do WSDL 1.1 (usado pelos servicos .asmx
     * classicos da SEFAZ): quando ha uma unica part referenciando um elemento global, o
     * corpo do SOAP contem esse elemento DIRETAMENTE, sem nenhum wrapper com o nome da
     * operacao. Envelopar {@code nfeDadosMsg} dentro de {@code <nfeRecepcaoEventoNF>}
     * (como fazíamos antes) faz o parametro chegar nulo do lado do servidor - e essa e a
     * causa mais provavel do NullReferenceException que persistia mesmo depois de corrigir
     * a cadeia de certificados.
     * <p>
     * Confirmado contra o WSDL real (2026-09-17): este servico nao usa cabecalho SOAP
     * (nfeCabecMsg).
     */
     ...
     * A action identifica a OPERACAO independente do corpo estar ou nao envelopado por um
